...
$packageArgs = @{
  ...
  url64         = 'https://github.com/Amulet-Team/Amulet-Map-Editor/releases/download/0.10.45/Amulet-v0.10.45-Windows-x64.zip'
  checksum64    = '7997350bd16cc1fada89a7e5db9c0a886322a059ee298c4f2b78be6e5c6e30a5'
