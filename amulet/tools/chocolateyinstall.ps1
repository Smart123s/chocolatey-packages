...
$packageArgs = @{
  ...
  url64         = 'https://github.com/Amulet-Team/Amulet-Map-Editor/releases/download/0.10.23/Amulet-v0.10.23-Windows-x64.zip'
  checksum64    = 'a658d207ed47f1e32b412726b3c8afc245ef6aa88371baee1a77d36984c5dabd'
