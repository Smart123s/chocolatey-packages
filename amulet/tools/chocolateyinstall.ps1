...
$packageArgs = @{
  ...
  url64         = 'https://github.com/Amulet-Team/Amulet-Map-Editor/releases/download/0.10.25/Amulet-v0.10.25-Windows-x64.zip'
  checksum64    = '9c5151298390354ecb2ec3493ef5a8ee25e8b6eb275b970f6702af809305a175'
